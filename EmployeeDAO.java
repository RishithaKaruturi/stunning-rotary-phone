...
public class EmployeeDAO 
{
    public boolean insertEmployee(Employee emp)
    {
    	...
    	try
    	{
    		...
    		pst.setDouble(3, emp.getSalary());  pst.setInt(4, emp.getAge()); 
    		pst.setDate(5, emp.getDoj());
    ...
    public Employee getEmployee(int empid)
    {
    	...
    	try
    	{
    		...
    		rs = pst.executeQuery();
    		if(rs.next())
    			emp = new Employee(rs.getInt(1),rs.getString(2),rs.getDouble(3),rs.getInt(4),rs.getDate(5));
    	}
    	catch(Exception ex)
    	{
    		ex.printStackTrace();
    ...
    public ArrayList<Employee> getEmployee()
    {
    	...
    	try
    	{
    		...
    		rs = pst.executeQuery();
    		while(rs.next())
    			elist.add(new Employee(rs.getInt(1),rs.getString(2),rs.getDouble(3),rs.getInt(4),rs.getDate(5)));
    	}
    	catch(Exception ex)
    	{
    		ex.printStackTrace();
